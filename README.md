...
🖥️ Lightweight Interface: Simple CLI or GUI (depending on your implementation) to start detection instantly.
...
Mediapipe (or alternative hand tracking framework)
